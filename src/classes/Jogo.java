...
public class Jogo extends JFrame {
		...
		//num é o número aleatório entre um e 3
			int num;
			//as três imagens
			ImageIcon copo = new ImageIcon("src/classes/imagens/copo.jpg"); //copo abaixado
			ImageIcon copoe = new ImageIcon("src/classes/imagens/copoe.jpg"); //copo levantado sem a bolinha
			ImageIcon copoc = new ImageIcon("src/classes/imagens/copoc.jpg"); //copo levantado com a bolinha
			JButton btn1;
			JButton btn2;
			JButton btn3;
		...
		public Jogo() {
			...
			JLabel lblTitulo = new JLabel("Encontre a Bolinha");
		...
		public class Action_button1 implements ActionListener {
			public void actionPerformed(ActionEvent e) {
				if(num == 1) {
					//Se este for o botão certo: Exibe a mensagem e...
